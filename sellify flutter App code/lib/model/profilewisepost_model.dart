...
//
//     final profilewisepostModel = profilewisepostModelFromJson(jsonString);

import 'dart:convert';

ProfilewisepostModel profilewisepostModelFromJson(String str) => ProfilewisepostModel.fromJson(json.decode(str));

String profilewisepostModelToJson(ProfilewisepostModel data) => json.encode(data.toJson());

class ProfilewisepostModel {
  String? responseCode;
  String? result;
  String? responseMsg;
  String? currency;
  ...
  factory ProfilewisepostModel.fromJson(Map<String, dynamic> json) => ProfilewisepostModel(
