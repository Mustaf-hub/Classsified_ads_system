...
class FilterpostScreen extends StatefulWidget {
  final int prodIndex;
  FilterpostScreen({super.key, required this.prodIndex});
...
class _FilterpostScreenState extends State<FilterpostScreen> {
  ...
  void initState() {
    ...
    area = filtersCont.filterData!.filter![widget.prodIndex].fullAddress.toString().split(",").first;

    String location = filtersCont.filterData!.filter![widget.prodIndex].fullAddress!;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        setState(() {});
        return await Get.to(CatwisepostList(catID: int.parse(filtersCont.filterData!.filter![widget.prodIndex].catId ?? ""), subcatId: int.parse(filtersCont.filterData!.filter![widget.prodIndex].subcatId ?? "")));
      },
      child: Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 10,),
              filtersCont.filterData!.filter![widget.prodIndex].adPrice == "0" ? SizedBox() : Expanded(
                child: ElevatedButton(
                  style: ButtonStyle(
                      elevation: WidgetStatePropertyAll(0),
                      alignment: Alignment.center,
                      ...
                      return [
                        SliverAppBar(
                          ...
                          flexibleSpace: FlexibleSpaceBar(
                            background: Storypage(stories: stories, title: filtersCont.filterData!.filter![widget.prodIndex].postTitle ?? "",),
                          ),
                        )
                      ];
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                              ...
                                              decoration: BoxDecoration(
                                                shape: BoxShape.circle,
                                                image: DecorationImage(fit: BoxFit.fitHeight, image: filtersCont.filterData!.filter![widget.prodIndex].ownerImg != null ? NetworkImage(Config.imageUrl+ filtersCont.filterData!.filter![widget.prodIndex].ownerImg!) : AssetImage("assets/userprofile.png",)),
                                              ),
                                            ),
                                            SizedBox(width: 10,),
                                            Column(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  filtersCont.filterData!.filter![widget.prodIndex].adPrice == "0" ? SizedBox() : Text("$currency ${addCommas(filtersCont.filterData!.filter![widget.prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
              SizedBox(height: 6,),
              Row(
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 5,),
                          Text(i == 0 ? "${filtersCont.filterData!.filter![widget.prodIndex].kmDriven ?? ""} km" : i == 1 ? filtersCont.filterData!.filter![widget.prodIndex].transmission ?? "" : filtersCont.filterData!.filter![widget.prodIndex].fuel ?? "", style: TextStyle(fontSize: height / 67, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium),),
                        ],
                      ),
                    ),
                ],
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city.toString().split(" ").first : i == 1 ? filtersCont.filterData!.filter![widget.prodIndex].noOwner ?? "" : filtersCont.filterData!.filter![widget.prodIndex].postDate.toString().split(" ").first, style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("FURNISHING".tr, filtersCont.filterData!.filter![widget.prodIndex].propertyFurnishing ?? "-"),
              SizedBox(height: 10,),
              subcatId == 2 ? SizedBox() : detailRow("CONSTRUCTION STATUS".tr, filtersCont.filterData!.filter![widget.prodIndex].propertyConstructionStatus ?? "-"),
