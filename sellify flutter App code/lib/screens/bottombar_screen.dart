                        ...
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8,),
                              currentIndex != 0 ? SizedBox() : Text("Home".tr, style: TextStyle(color: currentIndex == 0 ? WhiteColor : notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontSize: 14), overflow: TextOverflow.ellipsis,)
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8,),
                              currentIndex != 1 ? SizedBox() : Text("Chats".tr, style: TextStyle(color: currentIndex == 1 ? WhiteColor : notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontSize: 14),),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8,),
                              currentIndex != 2 ? SizedBox() : Text("Favourite".tr, style: TextStyle(color: currentIndex == 2 ? WhiteColor : notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontSize: 14),)
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8,),
                              currentIndex != 3 ? SizedBox() : Text("Account".tr, style: TextStyle(color: currentIndex == 3 ? WhiteColor : notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontSize: 14),)
                            ],
                          ),
                        ),
                      ),
