...
class _ChooselocationState extends State<Chooselocation> {
  ...
  void initState() {
    ...
    if(route == Routes.addlocationScreen){
      ...
      print(">>>>>>>>>>>> LATLONG $lathome $longhome");
    ...
    } else if(route == Routes.addlocationScreen) {
  ...
  Future<void> _onAddMarkerButtonPressed(double? lat, long) async {
    ...
    print("LATLNG G G G $lat, $long $markers");
    markers.add(Marker(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Scaffold(
              ...
              children: [
                ...
                Expanded(
                  ...
                  if (route == Routes.addproductScreen || route == Routes.categorylistScreen) {
                    ...
                    save("address", addresshome);
                    print("LOCATIOJN NNN $addresshome");
                    Get.back(
                      result: {
                    ...
                    getLocation();
                  } else if(searchCont.text.isNotEmpty){
                ...
                : mainButton(txt1: route == Routes.addproductScreen ? "Continue".tr : "Use Current Location".tr, loading: getEnter, context: context, containcolor: (addresshome.isEmpty && lathome == null && longhome == null) ? circleGrey : PurpleColor, onPressed1: () {
              getEnter = true;
              setState(() {});
              if (route == Routes.addproductScreen || route == Routes.categorylistScreen) {
                save("address", addresshome);
          ...
          appBar: (route == Routes.loginScreen || route == Routes.otpScreen || route == Routes.signupScreen) ? const PreferredSize(preferredSize: Size.fromHeight(0),child: SizedBox()) : AppBar(
            elevation: 0,
  ...
  Widget mapLocation(){
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5),
        (mapCont.mapApiModel == null || searchCont.text.isEmpty) ? SizedBox() : focusNode.hasFocus ? Expanded(
                ...
                child: InkWell(
                    onTap: () {
                      setState((){
                        ...
                        print("LLLLLLLLLLLLLLLL $lathome");
                        markers.clear();
                        _onAddMarkerButtonPressed(lathome, longhome);
        ...
        SizedBox(height: 20),
        focusNode.hasFocus ? SizedBox() : Text("Current Location".tr, style: TextStyle(fontSize: 16, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700, letterSpacing: 0.5),),
        SizedBox(height: 10,),
        focusNode.hasFocus ? SizedBox() : lathome == null ? shimmer(context: context, baseColor: notifier.shimmerbase2, height: 300,) : SizedBox(
          height: height/2.8,
          child: ClipRRect(
