...
class PostcvehicleController extends GetxController implements GetxService {
  ...
  Future postcVehicleWeb(transId) async {
  ...
  Future postcVehicle ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId, required String mainAmt, required String paymentMethod}) async {
    ...
    Map<String, String> body = {
      ...
      'commercial_brand_id': brandId,
      'commercial_model_id': modelId,
      'commercial_year': year.text,
  ...
  Future postSparepartWeb(transId) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future postSparepart ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId, required String mainAmt, required String paymentMethod}) async {
