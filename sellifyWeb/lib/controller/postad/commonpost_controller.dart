...
class CommonPostController extends GetxController implements GetxService {
  ...
  Future commonpostWeb(transId) async {
  ...
  Future commonPost ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId, required String mainAmt, required String paymentMethod}) async {
