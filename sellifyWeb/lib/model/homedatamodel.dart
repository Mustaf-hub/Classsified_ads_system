...
class HomedataModel {
  ...
  List<AdlistElement>? featurelist;
  List<AdlistElement>? adlist;
  ...
  factory HomedataModel.fromJson(Map<String, dynamic> json) => HomedataModel(
    ...
    featurelist: json["featurelist"] == null ? [] : List<AdlistElement>.from(json["featurelist"]!.map((x) => AdlistElement.fromJson(x))),
    adlist: json["adlist"] == null ? [] : List<AdlistElement>.from(json["adlist"]!.map((x) => AdlistElement.fromJson(x))),
    bannerlist: json["bannerlist"] == null ? [] : List<Bannerlist>.from(json["bannerlist"]!.map((x) => Bannerlist.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "featurelist": featurelist == null ? [] : List<dynamic>.from(featurelist!.map((x) => x.toJson())),
    "adlist": adlist == null ? [] : List<dynamic>.from(adlist!.map((x) => x.toJson())),
...
class AdlistElement {
  ...
  factory AdlistElement.fromJson(Map<String, dynamic> json) => AdlistElement(
    postId: json["post_id"],
    catId: json["cat_id"],
