...
//
//     final catwisepostModel = catwisepostModelFromJson(jsonString);

import 'dart:convert';

CatwisepostModel catwisepostModelFromJson(String str) => CatwisepostModel.fromJson(json.decode(str));

String catwisepostModelToJson(CatwisepostModel data) => json.encode(data.toJson());

class CatwisepostModel {
  String? responseCode;
  String? result;
  String? responseMsg;
  String? currency;
  ...
  factory CatwisepostModel.fromJson(Map<String, dynamic> json) => CatwisepostModel(
