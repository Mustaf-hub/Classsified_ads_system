      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          appBar: kIsWeb ? PreferredSize(
              ...
              child: Column(
                children: [
                  widget.title.isEmpty ? const SizedBox() : Expanded(child: CommonAppbar()),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: widget.title.isEmpty ? 0 : 1550 < constraints.maxWidth ? 200 : 1200 < constraints.maxWidth ? 100 : 20),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(widget.title.isEmpty ? 0 : 35),
                      child: AppBar(
                        toolbarHeight: 70,
          ...
          body: (widget.adPrice == "0" || widget.title.isEmpty) ? Padding(
            padding: EdgeInsets.symmetric(horizontal: (widget.adPrice == "0" && widget.title.isNotEmpty) ? (1550 < constraints.maxWidth ? 500 : 1150 < constraints.maxWidth ? 300 : 800 < constraints.maxWidth ? 150 : 0) : 0, vertical: (kIsWeb && widget.adPrice == "0" && widget.title.isNotEmpty) ? 20 : 0),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: kIsWeb && widget.title.isNotEmpty ? notifier.borderColor : Colors.transparent,
                  width: kIsWeb && widget.title.isNotEmpty ? 2 : 0,
                ),
              ),
              child: Column(
            ...
            padding: EdgeInsets.symmetric(horizontal: 1550 < constraints.maxWidth ? 500 : 1150 < constraints.maxWidth ? 300 : 800 < constraints.maxWidth ? 150 : 0, vertical: kIsWeb ? 20 : 0),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: const BorderRadius.only(
                                    ...
                                    bottomRight: Radius.circular(kIsWeb ? 20 : 0),
                                    bottomLeft: Radius.circular(kIsWeb ? 20 : 0)
                                  ),
                                ),
                                child: Column(
                                        ...
                                        child: Column(
                                          children: [
                                            TabBar(
                                              onTap: (value) {
                                                  selectedTab = value;
                                                  sheetController.animateTo(1.0, duration: const Duration(microseconds: 300), curve: Curves.bounceIn);
                                              },
  ...
  Future deleteChat(){
    return Get.bottomSheet(
      LayoutBuilder(
        builder: (context, constraints) {
          return Padding(
            padding: EdgeInsets.symmetric(horizontal: 1550 < constraints.maxWidth ? 500 : 1150 < constraints.maxWidth ? 300 : 800 < constraints.maxWidth ? 150 : 0),
            child: Container(
              decoration: BoxDecoration(
                color: notifier.getWhiteblackColor,
