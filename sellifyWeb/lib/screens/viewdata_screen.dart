...
class _ViewdataScreenState extends State<ViewdataScreen> {
  ...
  void initState() {
    ...
    String partsOfArea = homedataCont.homedata!.adlist![widget.prodIndex].fullAddress!;
      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          bottomNavigationBar: 750 < constraints.maxWidth ? const SizedBox()
              : Padding(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 1550 < constraints.maxWidth ? 500 : 1050 < constraints.maxWidth ? 300 : 750 < constraints.maxWidth ? 150 : 10),
                child: Row(
                  children: [
                    Expanded(
                    ...
                    const SizedBox(width: 10,),
                    homedataCont.homedata!.adlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Expanded(
                      child: ElevatedButton(
                        style: ButtonStyle(
                          elevation: const WidgetStatePropertyAll(0),
                          alignment: Alignment.center,
                          ...
                          return [
                            kIsWeb ? SliverAppBar(
                              ...
                              flexibleSpace: FlexibleSpaceBar(
                                background: Storypage(stories: stories, title: homedataCont.homedata!.adlist![widget.prodIndex].postTitle ?? "", isFeatured: homedataCont.homedata!.adlist![widget.prodIndex].isFeatureAd ?? "",),
                              ),
                            ) : SliverAppBar(
                              elevation: 0,
                              expandedHeight: kIsWeb ? 500 : 400,
                              floating: false,
                              pinned: true,
                              backgroundColor: notifier.getBgColor,
                              centerTitle: false,
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(fit: BoxFit.fitHeight, image: homedataCont.homedata!.adlist![widget.prodIndex].ownerImg != null ? NetworkImage(Config.imageUrl+ homedataCont.homedata!.adlist![widget.prodIndex].ownerImg!) : const AssetImage("assets/userprofile.png",)),
                                                    ),
                                                  ),
                                                  const SizedBox(width: 10,),
                                                  InkWell(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  homedataCont.homedata!.adlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Text("$currency ${addCommas(homedataCont.homedata!.adlist![widget.prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Flexible(child: Text(getAddress(address: homedataCont.homedata!.adlist![widget.prodIndex].fullAddress!), style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: GreyColor, fontSize: 14),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 5,),
                          Text(i == 0 ? "${homedataCont.homedata!.adlist![widget.prodIndex].kmDriven ?? ""} km" : i == 1 ?homedataCont.homedata!.adlist![widget.prodIndex].transmission ?? "" : homedataCont.homedata!.adlist![widget.prodIndex].fuel ?? "", style: TextStyle(fontSize: height / 67, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,),
                        ],
                      ),
                    ),
                ],
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city : i == 1 ? homedataCont.homedata!.adlist![widget.prodIndex].noOwner ?? "" : formatDate(homedataCont.homedata!.adlist![widget.prodIndex].postDate.toString().split(" ").first), style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),overflow: TextOverflow.ellipsis, maxLines: 1,),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("FURNISHING".tr, homedataCont.homedata!.adlist![widget.prodIndex].propertyFurnishing ?? "-"),
              const SizedBox(height: 10,),
              subcatId == 2 ? const SizedBox() : detailRow("CONSTRUCTION STATUS".tr, homedataCont.homedata!.adlist![widget.prodIndex].propertyConstructionStatus ?? "-"),
