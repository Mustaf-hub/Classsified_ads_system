...
class ProfilepostView extends StatefulWidget {
  final int prodIndex;
  const ProfilepostView({super.key, required this.prodIndex});
...
class _ProfilepostViewState extends State<ProfilepostView> {
  ...
  void initState() {
    ...
    setState(() {
      postType = profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postType ?? "";
      subcatId = int.parse(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].subcatId!);
    });
    isMeassageAvalable(profilewiseCont.profilewiseData!.ownerDetails!.postOwnerId ?? "0");
    if(subcatId == 0) {
      carbrandlistCon.carbrandlist(uid: getData.read("UserLogin") != null ? getData.read("UserLogin")["id"] : "0").then((value) {
        for(int i = 0; i < carbrandlistCon.carbrandData!.carbrandlist!.length;i++){
          if(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].brandId == carbrandlistCon.carbrandData!.carbrandlist![i].id){
            setState(() {
            ...
            carvariationCont.carvariation(brandId: carbrandlistCon.carbrandData!.carbrandlist![i].id).then((value) {
              for(int i = 0; i < carvariationCont.carvariationData!.carvariationlist!.length; i++){
                if(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].variantId == carvariationCont.carvariationData!.carvariationlist![i].id){
                  setState(() {
      ...
      subcategoryCont.subcatType(subcatID: subcatId.toString()).then((value) {
        for(int i = 0; i < subcategoryCont.subcatTypeData!.subtypelist!.length; i++){
          if(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].mobileBrand == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyType == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].bicyclesBrandId == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].serviceTypeId == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].accessoriesType == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].tabletType == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].sparepartTypeId == subcategoryCont.subcatTypeData!.subtypelist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].pgSubtype == subcategoryCont.subcatTypeData!.subtypelist![i].id){
            setState(() {
      ...
      bikescooterCvehicleCont.getvehicle(subcatId: subcatId.toString()).then((value) {
        for(int i = 0; i < bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist!.length; i++){
          if (profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].motocycleBrandId == bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].scooterBrandId == bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist![i].id ||
              profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].commercialBrandId == bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist![i].id) {
            setState(() {
          ...
          bikescooterCvehicleCont.getModel(brandId: bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist![i].id!).then((value) {
            for(int i = 0; i < bikescooterCvehicleCont.vehiclemodel!.bikescootermodellist!.length; i++){
              if(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].motorcycleModelId == bikescooterCvehicleCont.vehiclemodel!.bikescootermodellist![i].id ||
                  profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].scooterModelId == bikescooterCvehicleCont.vehiclemodel!.bikescootermodellist![i].id ||
                  profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].commercialModelId == bikescooterCvehicleCont.vehiclemodel!.bikescootermodellist![i].id){
                setState(() {
    ...
    lathome = double.parse(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].lats!);
    longhome = double.parse(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].longs!);
    _onAddMarkerButtonPressed(lathome, longhome);

    String partsOfArea = profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].fullAddress!;
    ...
    for (int i = 0; i < profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postAllImage!.length; i++) {
      stories.add(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postAllImage![i]);
    }
  }
  ...
  dayAgo(){
    setState(() {
      DateTime postDate = DateTime.parse("${profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postDate}");
          ...
          bottomNavigationBar: 750 < constraints.maxWidth ? const SizedBox()
            ...
            child: Row(
              children: [
                        ...
                        Navigator.push(context, screenTransDown(
                            routes: ChatScreen(
                              initialTab: 0,
                                ...
                                adPrice: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adPrice ?? "",
                                title: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postTitle ?? "",
                                adImage: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postImage!,
                ...
                const SizedBox(width: 10,),
                profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Expanded(
                  child: ElevatedButton(
                    style: ButtonStyle(
                        elevation: const WidgetStatePropertyAll(0),
                        alignment: Alignment.center,
                              ...
                              return [
                                kIsWeb ? SliverAppBar(
                                        ...
                                        children: [
                                          GetBuilder<ProfilewiseController>(
                                              builder: (profilewiseCont) {
                                                return InkWell(
                                                  onTap: () {
                                                    if(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].isFavourite == 0){
                                                      addfavCont.addFav(postId: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postId!).then((value) {
                                                        profilewiseCont.getProfilewise(profileId: profilewiseCont.profilewiseData!.ownerDetails!.postOwnerId ?? "");
                                                      },);
                                                    } else {
                                                      unFavBottomSheet(
                                                        context: context,
                                                        description: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adDescription ?? "",
                                                        title: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postTitle ?? "",
                                                        image: "${Config.imageUrl}${profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postImage}",
                                                        price: "$currency${addCommas(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adPrice!)}",
                                                        removeFun: () {
                                                          setState(() {
                                                            addfavCont.addFav(postId: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postId!).then((value) {
                                                              profilewiseCont.getProfilewise(profileId: profilewiseCont.profilewiseData!.ownerDetails!.postOwnerId ?? "");
                                                  ...
                                                  child: Container(
                                                    ...
                                                    padding: const EdgeInsets.all(10),
                                                    child: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].isFavourite == 1 ? Image.asset("assets/heartdark.png", height: 20, color: Colors.red.shade300,)
                                  ...
                                  flexibleSpace: FlexibleSpaceBar(
                                    background: Storypage(stories: stories, title: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postTitle ?? "", isFeatured: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].isFeatureAd ?? "",),
                                  ),
                                )
                                : SliverAppBar(
                                  elevation: 0,
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        image: DecorationImage(fit: BoxFit.fitHeight, image: profilewiseCont.profilewiseData!.ownerDetails!.ownerImg != null ? NetworkImage(Config.imageUrl+ profilewiseCont.profilewiseData!.ownerDetails!.ownerImg!) : const AssetImage("assets/userprofile.png",)),
                                                      ),
                                                    ),
                                                    const SizedBox(width: 10,),
                                                    InkWell(
                                                      onTap: () {
                                                        ...
                                                        profilewiseCont.getProfilewise(profileId: profilewiseCont.profilewiseData!.ownerDetails!.postOwnerId ?? "").then((value) {
                                                      ...
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(profilewiseCont.profilewiseData!.ownerDetails!.ownerName ?? "", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, letterSpacing: 0.7, fontFamily: FontFamily.gilroyMedium, color: notifier.getTextColor, ),),
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Flexible(child: Text(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postTitle!, style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 21),overflow: TextOverflow.ellipsis, maxLines: 2,)),
                  profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Text("$currency ${addCommas(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Flexible(child: Text(getAddress(address: profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].fullAddress!), style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: GreyColor, fontSize: 14),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 5,),
                          Text(i == 0 ? "${profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].kmDriven ?? ""} km" : i == 1 ?profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].transmission ?? "" : profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].fuel ?? "", style: TextStyle(fontSize: height / 67, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,),
                        ],
                      ),
                    ),
                ],
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city : i == 1 ? profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].noOwner ?? "" : formatDate(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postDate.toString().split(" ").first), style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),overflow: TextOverflow.ellipsis, maxLines: 1,),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10,),
              ReadMoreText(
                profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].adDescription!,
                trimLines: 3,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postYear!, style: TextStyle(fontSize: 14, fontFamily: FontFamily.gilroyMedium, letterSpacing: 0.5, color: notifier.getTextColor, fontWeight: ui.FontWeight.w700),),
                ],
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].fuel!, style: TextStyle(fontSize: 14, fontFamily: FontFamily.gilroyMedium, letterSpacing: 0.5, color: notifier.getTextColor, fontWeight: ui.FontWeight.w700),),
                ],
              ),
            ],
          ),
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("LISTED BY".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyListedBy ?? "-"),
              const SizedBox(height: 10,),
              detailRow("FURNISHING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyFurnishing ?? "-"),
              const SizedBox(height: 10,),
              detailRow("SUPER BUILTUP AREA (FT²)".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertySuperbuildarea ?? "-"),
              const SizedBox(height: 10,),
              detailRow("CARPET AREA (FT²)".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyCarpetarea ?? "-"),
              const SizedBox(height: 10,),
              detailRow("MAINTENANCE (MONTHLY)".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyMaintainceMonthly ?? "-"),
              const SizedBox(height: 10,),
              detailRow("CAR PARKING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyCarParking ?? "-"),
              const SizedBox(height: 10,),
              detailRow("WASHROOMS".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyBathroom ?? "-"),
              const SizedBox(height: 10,),
              detailRow("PROJECT NAME".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].projectName ?? "-"),
            ],
          )
            ...
            children: [
              ...
              const SizedBox(height: 10,),
              detailRow("BEDROOMS".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyBedroom ?? "-"),
              const SizedBox(height: 10,),
              detailRow("BATHROOMS".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyBathroom ?? "-"),
              const SizedBox(height: 10,),
              detailRow("FURNISHING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyFurnishing ?? "-"),
              const SizedBox(height: 10,),
              subcatId == 2 ? const SizedBox() : detailRow("CONSTRUCTION STATUS".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyConstructionStatus ?? "-"),
              ...
              subcatId == 2 ? const SizedBox() : Column(
                ...
                children: [
                  ...
                  detailRow("MAINTENANCE (MONTHLY)".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyMaintainceMonthly ?? "-"),
                  const SizedBox(height: 10,),
                  detailRow("TOTAL FLOORS".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyTotalFloor ?? "-"),
                  const SizedBox(height: 10,),
                  detailRow("FLOOR NO".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyFloorNo ?? "-"),
                  const SizedBox(height: 10,),
                  detailRow("CAR PARKING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyCarParking ?? "-"),
                  const SizedBox(height: 10,),
                  detailRow("FACING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyFacing ?? "-"),
                  const SizedBox(height: 10,),
                  detailRow("PROJECT NAME".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].projectName ?? "-"),
                ],
              ),
            ...
            children: [
              ...
              detailRow("LISTED BY".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyListedBy ?? "-"),
              const SizedBox(height: 10,),
              detailRow("PLOT AREA".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].plotArea ?? "-"),
              const SizedBox(height: 10,),
              detailRow("LENGTH".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].plotLength ?? "-"),
              const SizedBox(height: 10,),
              detailRow("BREADTH".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].plotBreadth ?? "-"),
              const SizedBox(height: 10,),
              detailRow("FACING".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].propertyFacing ?? "-"),
              const SizedBox(height: 10,),
              detailRow("PROJECT NAME".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].projectName ?? "-"),
        ...
        Container(
          ...
          child: subcatId <= 24 ? Column(
            ...
            children: [
              Text("Details".tr, style: TextStyle(fontSize: 16, fontFamily: FontFamily.gilroyMedium, color: notifier.getTextColor, ),),
              const SizedBox(height: 10,),
              detailRow("POSITION TYPE", profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].jobPositionType ?? "-"),
              detailRow("SALARY FROM".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].jobSalaryFrom ?? "-"),
              detailRow("SALARY TO".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].jobSalaryTo ?? "-"),
              detailRow("SALARY PERIOD".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].jobSalaryPeriod ?? "-"),
            ],
            ...
            children: [
              ...
              detailRow("YEAR".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].postYear ?? "-"),
              detailRow("KM DRIVEN".tr, profilewiseCont.profilewiseData!.searchlist![widget.prodIndex].kmDriven ?? "-"),
            ],
          )
              : subcatId == 39 ? Column(
            crossAxisAlignment: CrossAxisAlignment.start,
