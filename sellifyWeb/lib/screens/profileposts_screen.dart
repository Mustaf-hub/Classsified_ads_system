      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          appBar: kIsWeb ? PreferredSize(
              ...
              child: CommonAppbar(title: "Profile".tr, fun: () {
                Get.back();
              },)) : AppBar(
                                                          ...
                                                          Expanded(
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                Flexible(child: Text(getAddress(address: profilewiseCont.profilewiseData!.searchlist![index].fullAddress!), style: TextStyle(color: notifier.getTextColor, fontSize: 16, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,)),
                                                              ],
                                                            ),
                                                          ),
                                                          const SizedBox(width: 10,),
                                                          Text(formatDate(profilewiseCont.profilewiseData!.searchlist![index].postDate.toString().split(" ").first), style: TextStyle(color: notifier.getTextColor, fontSize: 16, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,),
                                                        ],
                                                      )
                                                    ],
                                                  ),
