...
class _FavouriteViewState extends State<FavouriteView> {
  ...
  void initState() {
    ...
    String partsOfArea = myfavCont.myfavData!.myadList![prodIndex].fullAddress!;
          ...
          bottomNavigationBar: 750 < constraints.maxWidth ? const SizedBox()
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 10,),
                myfavCont.myfavData!.myadList![prodIndex].adPrice == "0" ? const SizedBox() : Expanded(
                  child: ElevatedButton(
                    style: ButtonStyle(
                        elevation: const WidgetStatePropertyAll(0),
                        alignment: Alignment.center,
                        ...
                        return [
                          kIsWeb ? SliverAppBar(
                            ...
                            flexibleSpace: FlexibleSpaceBar(
                              background: Storypage(stories: stories, title: myfavCont.myfavData!.myadList![prodIndex].postTitle ?? "", isFeatured: myfavCont.myfavData!.myadList![prodIndex].isFeatureAd ?? "",),
                            ),
                          )
                          : SliverAppBar(
                            elevation: 0,
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                                 ...
                                                 decoration: BoxDecoration(
                                                   shape: BoxShape.circle,
                                                   image: DecorationImage(fit: BoxFit.fitHeight, image: myfavCont.myfavData!.myadList![prodIndex].ownerImg != null ? NetworkImage(Config.imageUrl+ myfavCont.myfavData!.myadList![prodIndex].ownerImg!) : const AssetImage("assets/userprofile.png",)),
                                                 ),
                                               ),
                                              const SizedBox(width: 10,),
                                              InkWell(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  myfavCont.myfavData!.myadList![prodIndex].adPrice == "0" ? const SizedBox() : Text("$currency ${addCommas(myfavCont.myfavData!.myadList![prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Flexible(child: Text(getAddress(address: myfavCont.myfavData!.myadList![prodIndex].fullAddress!), style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: GreyColor, fontSize: 14),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 5,),
                          Text(i == 0 ? "${myfavCont.myfavData!.myadList![prodIndex].kmDriven ?? ""} km" : i == 1 ?myfavCont.myfavData!.myadList![prodIndex].transmission ?? "" : myfavCont.myfavData!.myadList![prodIndex].fuel ?? "", style: TextStyle(fontSize: height / 67, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,),
                        ],
                      ),
                    ),
                ],
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city : i == 1 ? myfavCont.myfavData!.myadList![prodIndex].noOwner ?? "" : formatDate(myfavCont.myfavData!.myadList![prodIndex].postDate.toString().split(" ").first), style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),overflow: TextOverflow.ellipsis, maxLines: 1,),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("FURNISHING".tr, myfavCont.myfavData!.myadList![prodIndex].propertyFurnishing ?? "-"),
              const SizedBox(height: 10,),
              subcatId == 2 ? const SizedBox() : detailRow("CONSTRUCTION STATUS".tr, myfavCont.myfavData!.myadList![prodIndex].propertyConstructionStatus ?? "-"),
