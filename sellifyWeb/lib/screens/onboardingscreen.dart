                ...
                child: Column(
                  ...
                  children: [
                    ...
                    currentPage == 2 ? (750 < constraints.maxWidth ? Row(
                      children: [
                        const Spacer(),
                        Expanded(flex: 1200 > constraints.maxWidth ? 2 : 1, child: mainButton(context: context,txt1: "Get Started", containcolor: PurpleColor, onPressed1: () => Get.offAll(const Loginscreen(), transition: Transition.noTransition),)),
                        const Spacer(),
                      ],
                    ) : SizedBox(
                        width: double.infinity,
                        child: mainButton(context: context,txt1: "Get Started", containcolor: PurpleColor, onPressed1: () => Get.offAll(const Loginscreen(), transition: Transition.noTransition),)
                    )) : _buildPageIndicator(),
                    const Spacer(),
                    currentPage == 2 ? const SizedBox() : Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        GestureDetector(
                            onTap: () {
