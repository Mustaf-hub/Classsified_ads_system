                                    ...
                                    return Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(fit: BoxFit.fitHeight, image: imageuploadCont.imageFile != null ? FileImage(imageuploadCont.imageFile!,scale: 1) : const AssetImage("assets/sellifyLogo.png"), scale: 20)
                                        ),
                                      ),
                                    );
                                  }
                          ...
                          if (msgtype["otp_auth"] == "No") {
                            ...
                            if (msgtype["SMS_TYPE"] == "Msg91") {
                              ...
                              msgOtpController.twilloOtp(mobile: signupController.countryCode + signupController.mobile.text).then((value) {
                                if (value["Result"] == "true") {
                                  Get.to(const OtpScreen(), transition: Transition.noTransition, arguments: {
                                    "number": signupController.mobile.text,
                                    "cuntryCode": signupController.countryCode,
                                    "route": "signupScreen",
                                    "otpCode": value["otp"]
