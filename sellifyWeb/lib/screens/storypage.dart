...
class Storypage extends StatefulWidget {
  ...
  const Storypage({super.key, required this.stories, required this.title, required this.isFeatured});
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Scaffold(
          ...
          body: Padding(
            padding: EdgeInsets.symmetric(horizontal: 1600 < constraints.maxWidth ? 400 : 1200 < constraints.maxWidth ? 200 : 900 < constraints.maxWidth ? 50 : 0),
            child: Stack(
              ...
              children: [
                ClipRRect(
                  ...
                  child: InkWell(
                    onTap: () {
                      Get.to(GalleryviewScreen(galleryImage: widget.stories, title: widget.title, isFeatured: widget.isFeatured,), transition: Transition.noTransition);
                    },
                ...
                widget.stories.length == 1 ? const SizedBox() : SingleChildScrollView(
                            ...
                            child: InkWell(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  widget.stories.length == 1 ? const SizedBox() : Positioned(
                                    bottom: 0,
