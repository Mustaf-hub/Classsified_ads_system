                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        subcatID == "40" ? const SizedBox() : Column(
                          children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      brandStatus ? const SizedBox() : Text(">  $subtitle", style: TextStyle(color: notifier.getTextColor, fontSize: 16, fontFamily: FontFamily.gilroyMedium,),overflow: TextOverflow.ellipsis,),
                                    ],
                                  ),
                                              ...
                                              children: [
                                                Container(
                                                    ...
                                                    child: Text("${bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist![index].title}",
                                                      style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: notifier.getTextColor, fontSize: 16,),)),
                                                (brandStatus || bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist![index].modelCount == 0 ) ? const SizedBox() : Image.asset("assets/right.png", height: 20, color: notifier.getTextColor,)
                                              ],
                                            ),
                                          );
                                        },
