                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Column(
                          children: [
                            (subcatID == "65" || subcatID == "66") ? const SizedBox() : textFeild(validMsg: "Please enter details".tr, textController: type, context: context, hinttext: "Type *".tr, readStatus: true, onPressed1: () {
                              if(isOpened) return;
