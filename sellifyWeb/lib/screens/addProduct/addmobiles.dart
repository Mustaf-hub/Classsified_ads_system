...
class _AddmobilesState extends State<Addmobiles> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
      builder: (context, constraints) {
         return (adBrand && postingType == "Edit") ? Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color:  type == 1 ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color:  type == 2 ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                                        borderRadius: BorderRadius.circular(10)
                                    ),
                                    padding: const EdgeInsets.symmetric(vertical: 12),
                                    child: Row(
