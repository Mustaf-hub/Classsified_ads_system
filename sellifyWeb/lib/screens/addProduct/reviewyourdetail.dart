...
import '../paymentfail_screen.dart';
...
class _ReviewyourdetailState extends State<Reviewyourdetail> {
  ...
  adPost() {
    ...
    if(subcatID == "0"){
      if(postadController.isloading == false) {
        ...
        postadController.carpostAd(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "1"){
      if (propertiesCont.isloading == false) {
        ...
        propertiesCont.saleHome(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "2"){
      if (propertiesCont.isloading == false) {
        setState(() {
        ...
        propertiesCont.rentHome(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "3"){
      if (propertiesCont.isloading == false) {
        setState(() {
        ...
        propertiesCont.saleLandPlot(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "4"){
      if (propertiesCont.isloading == false) {
        setState(() {
        ...
        propertiesCont.rentOffice(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "5"){
      if (propertiesCont.isloading == false) {
        setState(() {
        ...
        propertiesCont.saleOffice(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "6"){
      if (propertiesCont.isloading == false) {
        setState(() {
        ...
        propertiesCont.pgpost(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "7"){
      if(postmobileCont.isloading == false){
        ...
        postmobileCont.postmobile(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "8"){
      if(postmobileCont.isloading == false){
        setState(() {
        ...
        postmobileCont.postAccessories(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "9"){
      if(postmobileCont.isloading == false){
        setState(() {
        ...
        postmobileCont.postTablet(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
      ...
      if(postadController.isloading == false){
        ...
        postadController.postJob(address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "25"){
      if(postbikeCont.isloading == false){
        ...
        postbikeCont.postBike(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    }
    else if(subcatID == "26"){
      if(postbikeCont.isloading == false){
        ...
        postbikeCont.postScooter(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "28"){
      if(postbikeCont.isloading == false){
        setState(() {
        ...
        postbikeCont.postBicycle(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "39"){
      if(postcvehicleCont.isloading == false){
        ...
        popup();
        postcvehicleCont.postcVehicle(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
    } else if(subcatID == "40"){
      ...
      if(postcvehicleCont.isloading == false){
        ...
        postcvehicleCont.postSparepart(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
      }
      ...
      if(postadController.isloading == false){
        ...
        postadController.postServices(adPrice: price, address: address, postType: postingType, recordId: recordId, updatecatId: updateCatId, paymentMethod: selectedPayment, mainAmt: mainAmount);
      }
    } else {
        setState(() {
        ...
        commonPostCont.commonPost(adPrice: price, address: address, recordId: recordId, postType: postingType, updatecatId: updateCatId, mainAmt: mainAmount, paymentMethod: selectedPayment);
    }
  }
      ...
      builder: (context, constraints) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Confirm your details".tr, style: TextStyle(fontSize: 20, fontFamily: FontFamily.gilroyBold, color: notifier.getTextColor),),
            centerTitle: true,
          ),
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: kIsWeb ? Get.height/3.8 : 0,),
                kIsWeb ? Padding(
                  padding: EdgeInsets.symmetric(vertical: 20, horizontal: 1550 < constraints.maxWidth ? 500 : 1050 < constraints.maxWidth ? 300 : 750 < constraints.maxWidth ? 150 : 20),
                  child: contButton(),
                ) : const SizedBox(),
  ...
  Widget contButton(){
    return mainButton(containcolor: PurpleColor, loading: isGetHold, context: context, txt1: "Post Now", onPressed1: () {
      selectedindex = 0;
      setState(() {});
      if(postingType == "Edit") {
        isGetHold = true;
                          ...
                          Padding(
                            ...
                            child: mainButton(
                              ...
                              onPressed1: () async {
                                ...
                                prefs.setString("paymentfor", selectedPayment == "Razorpay" ? "myAdsRazorpay" : "AdPost");
                                prefs.setString("statuspayment", paymentgaewayCont.gatewayData!.paymentdata![selectedindex].status ?? "");
                                prefs.setString("subcatPost", subcatID);

                                prefs.setString("postImageList", "");
                                prefs.setString("adpostData", "");

                                if (kIsWeb && selectedPayment != "Razorpay") {
                                  adPost();
                                }
                                ...
                                if(walletCheck && double.parse(mainAmount) == 0) {
                                  ...
                                  if(selectedPayment == "Razorpay") {
                                    ...
                                    if(kIsWeb){
                                      webPaymentCont.getPaymentUrl(
                                          body: {
                                            "email": getData.read("UserLogin")["email"],
                                            "amount": mainAmount
                                          }, url: "${Config.paymentBaseUrl}/w_payment/flutterwave/index.php");
                                    } else {
                                      Get.to(() => PaymentWebVIew(
                                            initialUrl:
                                                "${Config.paymentBaseUrl}flutterwave/index.php?amt=$mainAmount&email=${getData.read("UserLogin")["email"]}",
                                            navigationDelegate:
                                                (NavigationRequest
                                                    request) async {
                                              final uri =
                                    ...
                                    if (otid != null) {
                                      ...
                                      setState(() {
                                        postadController.transactionId =
                                            otid.toString();
                                        propertiesCont.transactionId =
                                            otid.toString();
                                        postmobileCont.transactionId =
                                            otid.toString();
                                        postbikeCont.transactionId =
                                            otid.toString();
                                        commonPostCont.transactionId =
                                            otid.toString();
                                        postcvehicleCont.transactionId =
                                            otid.toString();
                                      });
                                      adPost();
                                    }
  ...
  void _validateInputs() {
    ...
    if (!form.validate()) {
      ...
      _paymentCard.name = username.toString().split(" ").first;
  ...
  void handlePaymentError(PaymentFailureResponse response) {
    Get.to(const PaymentfailScreen(), transition: Transition.noTransition);
  }
