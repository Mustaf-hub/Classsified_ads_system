    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Scaffold(
          ...
          body: LayoutBuilder(
            builder: (context, constraints) {
              return (adType && postingType == "Edit") ? Padding(
  ...
  Widget houseProp(){
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 15,),
        subcatID == "2" ? const SizedBox() : optextFeild(validMsg: "Please add Construction Status".tr, textController: constructionStatus, context: context, hinttext: "Construction Status".tr, readStatus: true, onPressed1: () {
          if(isOpened) return;
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color:  propertiesCont.propType == "8" ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color:  propertiesCont.propType == "9" ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                          borderRadius: BorderRadius.circular(10)
                      ),
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      child: Row(
  ...
  Widget shopOffice(){
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 15,),
        subcatID == "4" ? const SizedBox() : textFeild(validMsg: "Please add Construction Status".tr, textController: constructionStatus, context: context, hinttext: "Construction Status".tr,  readStatus: true, onPressed1: () {
          if(isOpened) return;
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: propertiesCont.pgMealsincluded == "0" ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                      borderRadius: BorderRadius.circular(10)
                  ),
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  child: Row(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: propertiesCont.pgMealsincluded == "1" ? const Color(0xFFece3ff) : notifier.getWhiteblackColor,
                      borderRadius: BorderRadius.circular(10)
                  ),
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  child: Row(
