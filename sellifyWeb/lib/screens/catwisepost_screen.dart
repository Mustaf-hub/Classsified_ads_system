...
class _CatwisepostScreenState extends State<CatwisepostScreen> {
  ...
  void initState() {
    ...
    String partsOfArea = catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].fullAddress!;
          ...
          bottomNavigationBar: 750 < constraints.maxWidth ? const SizedBox()
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 10,),
                catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Expanded(
                  child: ElevatedButton(
                    style: ButtonStyle(
                        elevation: const WidgetStatePropertyAll(0),
                        alignment: Alignment.center,
                              ...
                              return [
                                kIsWeb ? SliverAppBar(
                                  ...
                                  flexibleSpace: FlexibleSpaceBar(
                                    background: Storypage(stories: stories, title: catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].postTitle ?? "", isFeatured: catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].isFeatureAd ?? "",),
                                  ),
                                ) : SliverAppBar(
                                  elevation: 0,
                                  expandedHeight: 400,
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                      ...
                                                      decoration: BoxDecoration(
                                                        shape: BoxShape.circle,
                                                        image: DecorationImage(fit: BoxFit.fitHeight, image: catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].ownerImg != null ? NetworkImage(Config.imageUrl+ catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].ownerImg!) : const AssetImage("assets/userprofile.png",)),
                                                      ),
                                                    ),
                                                    const SizedBox(width: 10,),
                                                    Column(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].adPrice == "0" ? const SizedBox() : Text("$currency ${addCommas(catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Flexible(child: Text(getAddress(address: catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].fullAddress!), style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: GreyColor, fontSize: 14),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city : i == 1 ? catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].noOwner ?? "" : formatDate(catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].postDate.toString().split(" ").first), style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),overflow: TextOverflow.ellipsis, maxLines: 1,),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("FURNISHING".tr, catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].propertyFurnishing ?? "-"),
              const SizedBox(height: 10,),
              subcatId == 2 ? const SizedBox() : detailRow("CONSTRUCTION STATUS".tr, catwisePostCont.catwisepostData!.searchlist![widget.prodIndex].propertyConstructionStatus ?? "-"),
