...
class PostcvehicleController extends GetxController implements GetxService {
  ...
  Future postcVehicle ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId}) async {
  ...
  Future postSparepart ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId}) async {
