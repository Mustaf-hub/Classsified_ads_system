...
class PostbikeController extends GetxController implements GetxService {
  ...
  Future postBike ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId}) async {
  ...
  Future postScooter ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId}) async {
  ...
  Future postBicycle ({required String adPrice, required String address, required String postType, required String recordId, required String updatecatId}) async {
