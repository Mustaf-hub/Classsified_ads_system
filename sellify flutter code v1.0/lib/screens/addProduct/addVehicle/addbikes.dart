                                      ...
                                      return brandStatus ? InkWell(
                                        ...
                                        onTap: () {
                                          if (subcatID == "28") {
                                            ...
                                            print("GET VEHICLE ID ${bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist![index].id}");
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: Text("${bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist![index].title}",
                                                  style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: notifier.getTextColor, fontSize: 16,),)),
                                            brandStatus ? SizedBox() : Image.asset("assets/right.png", height: 20, color: notifier.getTextColor,)
                                          ],
                                        ),
                                      );
                                    },
