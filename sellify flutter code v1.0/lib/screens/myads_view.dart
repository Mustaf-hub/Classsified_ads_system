...
class _MyadsViewState extends State<MyadsView> {
  ...
  void initState() {
      ...
      bikescooterCvehicleCont.getvehicle(subcatId: subcatId.toString()).then((value) {
        for(int i = 0; i < bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist!.length; i++){
          ...
          bikescooterCvehicleCont.getModel(brandId: bikescooterCvehicleCont.bikescootercvehicle!.bikescooterbrandlist![i].id!).then((value) {
            print(">>>>>>>>>>>>>>> MODEL ID ${myadlistCont.myadlistData!.myadList![prodIndex].motorcycleModelId}");
    ...
    if(partArea[0] != "") {
     area = partArea[0];
     adAddress = myadlistCont.myadlistData!.myadList![prodIndex].fullAddress!;
    } else {
      area = partArea[1];
      adAddress = "${partArea[1]}, ${partArea[2]}";
    }

    String location = myadlistCont.myadlistData!.myadList![prodIndex].fullAddress!;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<MyadlistController>(
        builder: (myadlistCont) {
          return (myadlistCont.myadlistData!.myadList![prodIndex].isExpire == "1" && myadlistCont.myadlistData!.myadList![prodIndex].isSold == "1") ? SizedBox() : Padding(
            ...
            child: Row(
              children: [
                        ...
                        setState(() {
                          if(subcatId == 0){
                            ...
                            Get.toNamed(Routes.chooseLocation, arguments: {
                             ...
                             subcategoryCont.subcatType(subcatID: subcatId.toString()).then((value) {
                               Get.toNamed(Routes.addproperties, arguments: {
                             ...
                             Get.toNamed(Routes.addjobDetail, arguments: {
                             ...
                             bikescooterCvehicleCont.getvehicle(subcatId: subcatId.toString()).then((value) {
                               Get.toNamed(Routes.addbikes, arguments: {
                                 "subcatId" : subcatId.toString(),
                                 "adIndex" : prodIndex,
                                 "postingType" : "Edit"
                               });
                             ...
                             bikescooterCvehicleCont.getvehicle(subcatId: subcatId.toString()).then((value) {
                               Get.toNamed(Routes.addcVehicle, arguments: {
                                 "subcatId" : subcatId.toString(),
                                 "adIndex" : prodIndex,
                                 "postingType" : "Edit"
                               });
                             ...
                             postadController.subcatId = subcatId.toString();
                             subcategoryCont.subcatType(subcatID: subcatId.toString()).then((value) {
                               Get.toNamed(Routes.addservices, arguments: {
                                 "subcatId" : subcatId.toString(),
                                 "adIndex" : prodIndex,
                                 "postingType" : "Edit"
                               });
                             ...
                             Get.toNamed(Routes.adcommonpost, arguments: {
                               "subcatId" : subcatId.toString(),
                               "adIndex" : prodIndex,
                               "postingType" : "Edit"
                             });
                ...
                SizedBox(width: 10,),
                myadlistCont.myadlistData!.myadList![prodIndex].isApprove == "0" ? SizedBox() : (myadlistCont.myadlistData!.myadList![prodIndex].isExpire == "1" && myadlistCont.myadlistData!.myadList![prodIndex].isSold == "1") ? SizedBox() : (myadlistCont.myadlistData!.myadList![prodIndex].isExpire == "0" && myadlistCont.myadlistData!.myadList![prodIndex].isSold == "1") ? Expanded(child: Text("Already soldout.".tr, style: TextStyle(fontFamily: FontFamily.gilroyBold, fontWeight: FontWeight.w600, color: notifier.getTextColor, fontSize: 18),textAlign: TextAlign.center,))
                    : Expanded(
                      child: ElevatedButton(
                          style: ButtonStyle(
                                                ...
                                                for(int i = 0; i < mark.length; i++)
                                                  Column(
                                                    children: [
                                                      ...
                                                      i == 1 ? SizedBox() : Divider(color: lightGreyColor,),
                                                    ],
                                                  ),
                                                SizedBox(height: 20,),
                                                Spacer(),
                                                          ...
                                                          child: SizedBox(
                                                            ...
                                                            child: ElevatedButton(
                                                                style: ButtonStyle(
                                                                  ...
                                                                  elevation: WidgetStatePropertyAll(0),
                                                                  shape: WidgetStatePropertyAll(
                                                                    RoundedRectangleBorder(side: BorderSide(color: Colors.transparent), borderRadius: BorderRadius.circular(12)),
                                                                  ),
                                                                ),
                                                                onPressed: () {
              ...
              return [
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Storypage(stories: stories, title: myadlistCont.myadlistData!.myadList![prodIndex].postTitle ?? "",),
                  ),
                )
              ];
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  myadlistCont.myadlistData!.myadList![prodIndex].adPrice == "0" ? SizedBox() : Text("${currency} ${addCommas(myadlistCont.myadlistData!.myadList![prodIndex].adPrice!)}", style: TextStyle(fontWeight: FontWeight.w700, fontFamily: FontFamily.gilroyRegular, color: notifier.getTextColor, fontSize: 18),),
                ],
              ),
              SizedBox(height: 6,),
              Row(
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 5,),
                        Flexible(child: Text(adAddress, style: TextStyle(fontFamily: FontFamily.gilroyMedium, color: GreyColor, fontSize: 14),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                  ),
                  SizedBox(width: 20,),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 5,),
                          Text(i == 0 ? "${myadlistCont.myadlistData!.myadList![prodIndex].kmDriven ?? ""} km" : i == 1 ? myadlistCont.myadlistData!.myadList![prodIndex].transmission ?? "" : myadlistCont.myadlistData!.myadList![prodIndex].fuel ?? "", style: TextStyle(fontSize: height / 67, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium),),
                        ],
                      ),
                    ),
                ],
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(i == 0 ? city.toString().split(" ").first : i == 1 ? myadlistCont.myadlistData!.myadList![prodIndex].noOwner ?? "" : myadlistCont.myadlistData!.myadList![prodIndex].postDate.toString().split(" ").first, style: TextStyle(fontSize: height / 60, color: notifier.getTextColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700),),
                              ],
                            ),
                          ),
                        ],
        ...
        Container(
          ...
          child: (subcatId == 4 || subcatId == 5) ? Column(
            ...
            children: [
              ...
              detailRow("FURNISHING".tr, myadlistCont.myadlistData!.myadList![prodIndex].propertyFurnishing ?? "-"),
              SizedBox(height: 10,),
              subcatId == 2 ? SizedBox() : detailRow("CONSTRUCTION STATUS".tr, myadlistCont.myadlistData!.myadList![prodIndex].propertyConstructionStatus ?? "-"),
                  ...
                  child: mainButton(
                    ...
                    onPressed1: () {
                      ...
                      if(walletCheck && double.parse(mainAmount) == 0) {
                        ...
                        print("Posted ???");
                        popup();
                        repubCont.getRepublish(postId: myadlistCont.myadlistData!.myadList![selectedPost].postId.toString(), transId: "0", pMethod: "5", package: listpackageCont.listpackageData!.packageData![selectedPackage].id.toString(), isPaid: "1", walletAmt: walletMain.toString());
                          ...
                          paystackCont.getPaystack(amount: mainAmount).then((value) {
                            Get.to(() => PaymentWebVIew(
                              ...
                              if (otid != null) {
                                ...
                                popup();
                                repubCont.getRepublish(postId: myadlistCont.myadlistData!.myadList![selectedPost].postId.toString(), transId: otid, pMethod: paymentgaewayCont.gatewayData!.paymentdata![selectedindex].id.toString(), package: listpackageCont.listpackageData!.packageData![selectedPackage].id.toString(), isPaid: "1", walletAmt: walletMain.toString());
                              }
                            });
                          },);
                        }
        ...
        builder: (context) {
          return UsePaypal(
            ...
            onSuccess: (Map params) {
              showToastMessage("Payment done Successfully".tr);
              popup();
              repubCont.getRepublish(postId: myadlistCont.myadlistData!.myadList![selectedPost].postId.toString(), transId: params["paymentId"].toString(), pMethod: paymentgaewayCont.gatewayData!.paymentdata![selectedindex].id.toString(), package: listpackageCont.listpackageData!.packageData![selectedPackage].id.toString(), isPaid: "1", walletAmt: walletMain.toString());
            },
            onError: (error) {
  ...
  void handlePaymentSuccess(PaymentSuccessResponse response) {
    popup();
    repubCont.getRepublish(postId: myadlistCont.myadlistData!.myadList![selectedPost].postId.toString(), transId: response.paymentId.toString(), pMethod: paymentgaewayCont.gatewayData!.paymentdata![selectedindex].id.toString(), package: listpackageCont.listpackageData!.packageData![selectedPackage].id.toString(), isPaid: "1", walletAmt: walletMain.toString());
  }
