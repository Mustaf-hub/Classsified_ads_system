...
class _CatwisepostListState extends State<CatwisepostList> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      print("FILTER Uploded : ${filtersCont.filterUploded}");
    });
    super.initState();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 10),
                          catwisePostCont.isloading ? Expanded(
                            child: ListView.separated(
                              ...
                              filtersCont.filterUploded ? (
                                  (filtersCont.filterData == null || filtersCont.filterData!.filter!.isEmpty || catwisePostCont.catwisepostData!.searchlist!.isEmpty) ? Expanded(
                                    child: Center(
                                                    ...
                                                    Expanded(
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Flexible(child: Text(" ${filtersCont.filterData!.filter![index].fullAddress}", style: TextStyle(color: notifier.iconColor, fontSize: 14, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,)),
                                                        ],
                                                      ),
                                                    ),
                                                    SizedBox(width: 10,),
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: Row(
                                                        children: [
                                                          Image.asset("assets/location-pin.png", height: 16, color: notifier.iconColor),
                                                          Flexible(child: Text(" ${catwisePostCont.catwisepostData!.searchlist![index].fullAddress}", style: TextStyle(color: notifier.iconColor, fontSize: 14, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,)),
                                                        ],
                                                      ),
                                                    ),
                                                    SizedBox(width: 10,),
  ...
  Future filterBottom(var setState){
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        filterupdateCont.selectedFiltersList.isEmpty ? SizedBox() : Text("Selected Filters".tr, style: TextStyle(color: notifier.getTextColor, fontSize: 16, fontFamily: FontFamily.gilroyRegular, fontWeight: FontWeight.w700),),
                                        const SizedBox(height: 10,),
                                        filterupdateCont.selectedFiltersList.isEmpty ? SizedBox() : Wrap(
                                            spacing: 10,
                                            // runSpacing: 5,
                                                  ...
                                                  onDeleted:() {
                                                    setState(() {
                                                      ...
                                                      if (widget.catID == 1) {
                                                        for (int c = 0; c < carbrandlistCont.carbrandData!.carbrandlist!.length; c++) {
                                                          if(carbrandlistCont.carbrandData!.carbrandlist![c].title == filterupdateCont.selectedFiltersList[i]){
                                                            ...
                                                            print("Remove CarBrand : $brandId");
                                                          }
                                                        }
                                                      } else if (widget.catID == 5) {
                                                        print("COMERCAILA<  << <${bikeScoCvehicleCon.bikescootercvehicle!}");
                                                        ...
                                                        print("KLKLKLKLKLKL");
                                                          if(bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist![b].title == filterupdateCont.selectedFiltersList[i]){
                                                            ...
                                                            print("Remove CarBrand : $checkData");
                                                          }
                                                        }
                                                      } else if(widget.catID == 7){
                                                        for (int b = 0; b < bikeScoCvehicleCon.bikescootercvehicle!.bikescooterbrandlist!.length; b++) {
                                                      ...
                                                      if(positionList.contains(filterupdateCont.selectedFiltersList[i])){
                                                        ...
                                                        print("PROPERTY LISTING BY > > $propertyListing");
                                                      }
                                                      ...
                                                      if(propertyListing.contains(filterupdateCont.selectedFiltersList[i])){
                                                        ...
                                                        if(checkData.contains(filterupdateCont.selectedFiltersList[i])){
                                                          print("FILTERE <<< <<< >>> >>> ${filterupdateCont.selectedFiltersListData}");
            ...
            Expanded(
              ...
              child: selectFilter == 0 ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  : selectFilter == 1 ? sliderSelect(note: "Budget".tr, type: "", minValue: 0, maxValue: 1000000, currentValue: RangeValues(0, 1000000),
                setState1: setState1,
                getDataIn: (value) {
                  setState1(() {
                ...
                setState1(() {
                  ...
                  : selectFilter == 3 ? checkBoxSelect(dataList: inbox.ownersType, setState1: setState1, selctedListData: ownerLengthDataList, transData: inbox.ownersTypeData, getDataIn: (value) {
                     setState1(() {
                       ...
                       print("OwnerLength TYPE ${selectedownerLength}");
                     });
                  },)
                ...
                setState1(() {
                  ...
                  : selectFilter == 5 ? checkBoxSelect(dataList: inbox.fuel, setState1: setState1, transData: inbox.fuelData, selctedListData: fuelDataList, getDataIn: (value) {
                   setState1(() {
                     ...
                     print("FUEL TYPE ${selectedfuelData}");
                   });
                  })
                ...
                setState1(() {
                  ...
                  print("OwnerLength TYPE ${transmissionData}");
                });
              }, )
                ...
                setState1(() {
                  ...
                  print("OwnerLength TYPE ${ownerLength}");
                });
              })
                  : const SizedBox(),
            ),
    ...
    return widget.subcatId <= 2 ? Expanded(
      ...
      child: selectFilter == 0 ? sliderSelect(note: "Budget".tr, minValue: 0,  type: "", maxValue: widget.subcatId == 1 ? 50000000 : 500000, currentValue: RangeValues(0, widget.subcatId == 1 ? 50000000 : 500000),
        ...
        setState1(() {
          ...
          print("OwnerLength TYPE $bedroom - $bedroomData");
        });
      })
        ...
        print("OwnerLength TYPE $bathroom - $bathroomData");
      })
        ...
        setState1(() {
          ...
          print("OwnerLength TYPE $furnishing - $furnishingData");
        });
      }))
        ...
        setState1(() {
          ...
          print("OwnerLength TYPE $constStatus - $constStatusData");
        });
        ...
        setState1(() {
          ...
          print("propertyListedBy### $propertyListedBy -$propertyListedByData");
        });
      }))
        ...
        getDataIn: (value) {
          setState1(() {
            ...
            print("OwnerLength TYPE ${builtupArea}");
          });
        },) : checkBoxSelect(dataList: inbox.listedBy, setState1: setState1, selctedListData: propertyListingData, transData: inbox.listedByData, getDataIn: (value) {
        setState1(() {
          propertyListedBy = value.toString().split("-").first;
          propertyListedByData = value.toString().split("-").last;
          propertyListing = propertyListedBy.split(",");
          print("LIST DATA > > > > $propertyListing");
          propertyListingData = propertyListedByData.split(",");
          print("propertyListedBy@@@@ $propertyListedBy -$propertyListedByData");
        });
      }))
        ...
        setState1(() {
          ...
          print("OwnerLength TYPE ${bachelor}");
        });
      }))
              ...
              onTap: (){
                setState1(() {
                  if(mobilebrandId.contains(subcatCont.subcatTypeData!.subtypelist![index].id)){
                    ...
                    brandId = mobilebrandId.join(",");
                    print("Mobile Brands Id ${brandId}");
                  } else {
              ...
              Expanded(
                ...
                child: selectFilter == 0 ? checkBoxSelect(dataList: inbox.positionType, setState1: setState1, selctedListData: positionListData, transData: inbox.positionTypeData, getDataIn: (value) {
                  setState1((){
                    ...
                    print("JOB FILTER > > $positionListData");
                  });
                })
                  ...
                  setState1((){
                    ...
                    print("JOB FILTER > > $salaryPeriodData");
                  });
                })
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return (widget.subcatId == 28 && index == 2 && index == 3) ? SizedBox() : InkWell(
                      onTap: () {
                        setState1(() {
                          selectFilter = index;
                          checkData = [];
              ...
              Expanded(
                  flex: 2,
                   child: widget.subcatId == 40 ? (
                       ...
                       : SizedBox())
                      : (selectFilter == 0 ? sliderSelect(note: "Budget".tr, type: "", setState1: setState1, minValue: 0, maxValue: 1000000, currentValue: RangeValues(0, 1000000), getDataIn: (value) {
                     setState1(() {
                       budgetStart = value.toString().split("-").first;
                       budgetEnd = value.toString().split("-").last;
                       budget = "${"Budget".tr}: ${budgetStart} - ${budgetEnd}";
                        ...
                        onChanged: (value) {
                          setState1((){
                            ...
                            filterupdateCont.updateSelection(optionsList: "$note: $yearMin - $yearNow").then((value) {
                              ...
                              print("<><><><<>><><KSKDDKDK ${yearNow-yearMin}");
                            },);
                          });
                        },
