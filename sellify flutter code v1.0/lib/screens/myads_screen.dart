...
class _MyadsScreenState extends State<MyadsScreen> {
                  ...
                  child: myadlistCont.isloading ? SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          List myaddress = myadlistCont.myadlistData!.myadList![index].fullAddress.toString().split(",");
                          return Padding(
                            padding: const EdgeInsets.only(bottom: 14),
                            child: InkWell(
                              onTap: () {
                                Get.toNamed(Routes.myadsView, arguments: {
                                  "productindex" : index,
                                });
                              },
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Column(
                                            ...
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              myadlistCont.myadlistData!.myadList![index].isPaid == "0" ? SizedBox() : Container(
                                                decoration: BoxDecoration(
                                              ...
                                              SizedBox(height: 10,),
                                              Text("${myaddress[1]}, ${myaddress[2]}", style: TextStyle(color: notifier.getTextColor, fontSize: 14, fontFamily: FontFamily.gilroyMedium),overflow: TextOverflow.ellipsis, maxLines: 1,),
                                              SizedBox(height: 10,),
                                    ...
                                    Divider(color: circleGrey,),
                                    (myadlistCont.myadlistData!.myadList![index].isFeatureAd == "0" || myadlistCont.myadlistData!.myadList![index].daysRemaining == 0) ? SizedBox() : Container(
                                    ...
                                    GetBuilder<MyadlistController>(
                                      builder: (myadlistCont) {
                                        return myadlistCont.myadlistData!.myadList![index].isApprove == "0" ? SizedBox() : (myadlistCont.myadlistData!.myadList![index].isExpire == "1" && myadlistCont.myadlistData!.myadList![index].isSold == "1") ? SizedBox() : (myadlistCont.myadlistData!.myadList![index].isExpire == "0" && myadlistCont.myadlistData!.myadList![index].isSold == "1") ? Align(alignment: Alignment.centerRight,child: Text("Already soldout.".tr, style: TextStyle(fontFamily: FontFamily.gilroyBold, fontWeight: FontWeight.w600, color: notifier.getTextColor, fontSize: 16),))
                                            : Row(
                    ...
                    child: mainButton(
                      ...
                      onPressed1: () {
                        ...
                        if(walletCheck && double.parse(mainAmount) == 0) {
                          ...
                          print("Posted ???");
                          popup();
                          isFeature! ? makeFeatureCont.getMakeFeature(postId: myadlistCont.myadlistData!.myadList![selectedPost].postId.toString(), transactionId: "0", pMethodId: "5", wallAmt: walletMain.toString(), packageId: listpackageCont.listpackageData!.packageData![selectedPackage].id.toString())
  ...
  void handlePaymentError(PaymentFailureResponse response) {
    print("Payment Failed: ${response.message} - ${response}");
  }
