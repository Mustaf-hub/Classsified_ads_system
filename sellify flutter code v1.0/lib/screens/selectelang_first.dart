          ...
          child: Column(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  isDroped ? appBar() : SizedBox(),
                  isDroped ? SizedBox() : Center(child: Text("Select your Language", style: TextStyle(fontSize: 24, color: BlackColor, fontFamily: FontFamily.gilroyMedium, fontWeight: FontWeight.w700,letterSpacing: 1),)),
                  SizedBox(height: isDroped ? 0 : 10,),
                  isDroped ? SizedBox() : Center(
                  ...
                  isDroped ? SizedBox() : Text("Language", style: TextStyle(color: GreyColor, fontSize: 16, fontFamily: FontFamily.gilroyMedium),),
                  SizedBox(height: 20,),
                  isDroped ? SizedBox() : InkWell(
                    onTap: () {
                      setState(() {
                        isDroped = true;
                      });
                  ...
                  isDroped ? langDropdown() : SizedBox(),
                ],
              ),
              isDroped ? SizedBox() : Spacer(),
              isDroped ? SizedBox() : mainButton(txt1: "Continue".tr, context: context, containcolor: PurpleColor, onPressed1: () => Get.toNamed(Routes.chooseLocation),),
            ],
          ),
        ),
      ),
