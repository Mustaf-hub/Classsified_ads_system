 ...
 * @property string|null $messagingsellifyrier
 * @property string|null $voicesellifyrier
...
class PortingPortabilityInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload, string $phoneNumber = null)
    {
        ...
        $this->properties = [
            ...
            'messagingsellifyrier' => Values::array_get($payload, 'messaging_sellifyrier'),
            'voicesellifyrier' => Values::array_get($payload, 'voice_sellifyrier'),
