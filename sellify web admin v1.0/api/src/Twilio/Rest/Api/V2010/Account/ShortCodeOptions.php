...
abstract class ShortCodeOptions
{
     ...
     * @param string $shortCode Only show the ShortCode resources that match this pattern. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
...
class ReadShortCodeOptions extends Options
    ...
    /**
     * Only show the ShortCode resources that match this pattern. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
     *
     * @param string $shortCode Only show the ShortCode resources that match this pattern. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
     * @return $this Fluent Builder
     */
