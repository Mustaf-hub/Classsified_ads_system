...
abstract class DomainOptions
{
     ...
     * @param string $byocTrunkSid The SID of the BYOC Trunk(Bring Your Own sellifyrier) resource that the Sip Domain will be associated with.
...
class CreateDomainOptions extends Options
    ...
    /**
     * The SID of the BYOC Trunk(Bring Your Own sellifyrier) resource that the Sip Domain will be associated with.
     *
     * @param string $byocTrunkSid The SID of the BYOC Trunk(Bring Your Own sellifyrier) resource that the Sip Domain will be associated with.
     * @return $this Fluent Builder
     */
