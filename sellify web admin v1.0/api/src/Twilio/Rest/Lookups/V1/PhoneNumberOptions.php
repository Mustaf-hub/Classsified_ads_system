...
abstract class PhoneNumberOptions
{
     ...
     * @param string[] $type The type of information to return. Can be: `sellifyrier` or `caller-name`. The default is null.  sellifyrier information costs $0.005 per phone number looked up.  Caller Name information is currently available only in the US and costs $0.01 per phone number looked up.  To retrieve both types on information, specify this parameter twice; once with `sellifyrier` and once with `caller-name` as the value.
...
class FetchPhoneNumberOptions extends Options
    ...
    /**
     * The type of information to return. Can be: `sellifyrier` or `caller-name`. The default is null.  sellifyrier information costs $0.005 per phone number looked up.  Caller Name information is currently available only in the US and costs $0.01 per phone number looked up.  To retrieve both types on information, specify this parameter twice; once with `sellifyrier` and once with `caller-name` as the value.
     *
     * @param string[] $type The type of information to return. Can be: `sellifyrier` or `caller-name`. The default is null.  sellifyrier information costs $0.005 per phone number looked up.  Caller Name information is currently available only in the US and costs $0.01 per phone number looked up.  To retrieve both types on information, specify this parameter twice; once with `sellifyrier` and once with `caller-name` as the value.
     * @return $this Fluent Builder
     */
