...
abstract class ContentModels
{
    ...
    */
     ...
     * @property string $id
    */
    public static function createsellifydAction(array $payload = []): sellifydAction
    {
        return new sellifydAction($payload);
    }
     ...
     * @property string[] $media
     * @property sellifydAction[] $actions
    */
    public static function createTwiliosellifyd(array $payload = []): Twiliosellifyd
    {
        return new Twiliosellifyd($payload);
    }
    ...
    */
     ...
     * @property sellifydAction[] $actions
    */
    public static function createWhatsappsellifyd(array $payload = []): Whatsappsellifyd
    {
        return new Whatsappsellifyd($payload);
    }
    ...
    */
     ...
     * @property Twiliosellifyd $twiliosellifyd
     * @property TwilioCatalog $twilioCatalog
     * @property Whatsappsellifyd $whatsappsellifyd
...
class sellifydAction implements \JsonSerializable
{
    /**
     * @property string $type
     * @property string $title
...
class Twiliosellifyd implements \JsonSerializable
{
    /**
     * @property string $title
     * @property string $subtitle
...
class Whatsappsellifyd implements \JsonSerializable
{
    /**
     * @property string $body
     * @property string $footer
...
class Types implements \JsonSerializable
{
    ...
    */
        ...
        protected $twiliosellifyd;
        protected $twilioCatalog;
        protected $whatsappsellifyd;
    ...
    public function __construct(array $payload = []) {
        ...
        $this->twiliosellifyd = Values::array_get($payload, 'twiliosellifyd');
        $this->twilioCatalog = Values::array_get($payload, 'twilioCatalog');
        $this->whatsappsellifyd = Values::array_get($payload, 'whatsappsellifyd');
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'twiliosellifyd' => $this->twiliosellifyd,
            'twilioCatalog' => $this->twilioCatalog,
            'whatsappsellifyd' => $this->whatsappsellifyd,
