...
class Pay extends TwiML {
    ...
    /**
     * Add ValidsellifydTypes attribute.
     *
     * @param string[] $validsellifydTypes Comma separated accepted sellifyd types
     */
    public function setValidsellifydTypes($validsellifydTypes): self {
        return $this->setAttribute('validsellifydTypes', $validsellifydTypes);
    }
