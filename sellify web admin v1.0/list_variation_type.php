        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Car Variation Type List Management</h3>
                </div>
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                            <th>Sr No.</th>
							<th>Car Brand Title</th>
							<th>Car Variation Title</th>
											<th>Car Variation Type Title</th>
												<th>Car Variation Type Status</th>
												<th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $sellify->query("select * from sellify_variation_type");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											$blist = $sellify->query("select * from car_brand where id=".$row["brand_id"]."")->fetch_assoc();
											$vlist = $sellify->query("select * from car_variation where id=".$row["variation_id"]."")->fetch_assoc();
											$i = $i + 1;
											?>
											<tr>
                                                <td>
										   ...
										   <a href="add_variation_type.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
