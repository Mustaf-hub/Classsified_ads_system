                ...
                <table class="display" id="basic-1">
                        <thead>
                           <tr>
                                        ...
                                        <tbody>
                                            <?php 
											 $stmt = $sellify->query("SELECT * FROM `tbl_page`");
$i = 0;
while($row = $stmt->fetch_assoc())
{
	$i = $i + 1;
										   ...
										   <a href="add_page.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
