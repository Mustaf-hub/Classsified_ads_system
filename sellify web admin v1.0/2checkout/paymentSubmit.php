...
if(!empty($_POST['token'])){
    ...
    // sellifyd info
    $sellifyd_num = $_POST['sellifyd_num'];
    $sellifyd_cvv = $_POST['cvv'];
    $sellifyd_exp_month = $_POST['exp_month'];
    $sellifyd_exp_year = $_POST['exp_year'];
    ...
    // Set API key
    Twocheckout::privateKey('eQM)ID@&vG84u!O*g[p+');
    Twocheckout::sellerId('253248016872');
    Twocheckout::sandbox(true);
    
    try {
        // Charge a credit sellifyd
