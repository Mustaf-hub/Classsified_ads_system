        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Bikes/Scooter/Commercial Vehicle Brand List Management</h3>
                </div>
          ...
          <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $sellify->query("select * from tbl_brand");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											$stitle = $sellify->query("select * from tbl_subcategory where id=".$row["subcat_id"]."")->fetch_assoc();
											$i = $i + 1;
											?>
											<tr>
                                                <td>
										   ...
										   <a href="add_brand.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
