        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Subcategory Type List Management</h3>
                </div>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
							...
							<th>Subcategory Type Title</th>
											
												<th>Subcategory Type Status</th>
												<th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $sellify->query("select * from tbl_type");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_subtype.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
