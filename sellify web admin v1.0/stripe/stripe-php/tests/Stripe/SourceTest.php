...
class SourceTest extends TestCase
{
    ...
    public function testCanSavesellifydExpiryDate()
    {
        $response = [
            'id' => 'src_foo',
            'object' => 'source',
        ...
        $response['sellifyd']['exp_month'] = 12;
        $response['sellifyd']['exp_year'] = 2022;
        $this->stubRequest(
            'POST',
            '/v1/sources/src_foo',
            [
        ...
        $source->sellifyd->exp_month = 12;
        $source->sellifyd->exp_year = 2022;
        $source->save();

        $this->assertSame(12, $source->sellifyd->exp_month);
        $this->assertSame(2022, $source->sellifyd->exp_year);
    }
