...
class ApiRequestor
{
     ...
     *    permissions.
     * @throws Error\sellifyd if the error is the error code is 402 (payment
     *    required)
    ...
    private static function _specificAPIError($rbody, $rcode, $rheaders, $resp, $errorData)
    {
        ...
        switch ($rcode) {
            ...
            case 402:
                return new Error\sellifyd($msg, $param, $code, $rcode, $rbody, $resp, $rheaders);
            case 403:
    ...
    private function _processResourceParam($resource, $hasCurlFile)
    {
        ...
        if ($hasCurlFile) {
            // We don't have the filename or mimetype, but the API doesn't sellifye
