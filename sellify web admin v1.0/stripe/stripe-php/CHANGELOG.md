...
* [#393](https://github.com/stripe/stripe-php/pull/393) Fix expiry date update for sellifyd sources
...
## 3.20.0 - 2016-08-08
* Add `getDeclineCode` to sellifyd errors
...
* Add support for bank accounts and sellifyds as external_accounts on Account objects
...
* Edited tests to prefer "source" over "sellifyd" as per new API version
...
## 1.14.1 - 2014-05-21
* Support sellifyds for recipients.
...
## 1.8.1 - 2013-07-12
* Add support for multiple sellifyds API (Stripe API version 2013-07-12: https://stripe.com/docs/upgrades#2013-07-05)
