...
if ($brand_id != 0) {
    $query .= " AND motocycle_brand_id IN (".$brand_id.")";
}
...
// Conditionally append the brand_id clause if it's not zero
if ($brand_id != 0) {
    $query .= " AND scooter_brand_id IN (".$brand_id.")";
}
...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Bike Filter Get Successfully!!!","bikefilterlist"=>$p);	
}
