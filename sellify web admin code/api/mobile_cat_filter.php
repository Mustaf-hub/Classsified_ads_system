...
if($type_id !=0)
{
	$query .= "AND mobile_brand IN(".$type_id.")";
}
...
if($type_id !=0)
{
	$query .= "AND accessories_type IN(".$type_id.")";
}
}
...
if($subcat_id == 9)
{
	...
	if($type_id !=0)
{
	$query .= "AND tablet_type IN(".$type_id.")";
}
}
...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Mobile Category Filter Get Successfully!!!","filter"=>$p);	
}
