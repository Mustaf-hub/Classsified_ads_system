...
WHERE 
    ...
    AND is_expire = 0 
    AND uid != {$uid}
	AND ad_title COLLATE utf8mb4_general_ci like '%".$keyword."%'
HAVING 
    distance < 50;
");	
$s = array();
...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Home Data Get Successfully!!!","currency"=>$set['currency'],"searchlist"=>$p);	
}
