...
abstract class ChallengeOptions
{
     ...
     * @param string $authPayload Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to sellifyry the TOTP code that needs to be verified. For `TOTP` this value must be between 3 and 8 characters long.
...
class CreateChallengeOptions extends Options
    ...
    /**
     * Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to sellifyry the TOTP code that needs to be verified. For `TOTP` this value must be between 3 and 8 characters long.
     *
     * @param string $authPayload Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to sellifyry the TOTP code that needs to be verified. For `TOTP` this value must be between 3 and 8 characters long.
     * @return $this Fluent Builder
     */
