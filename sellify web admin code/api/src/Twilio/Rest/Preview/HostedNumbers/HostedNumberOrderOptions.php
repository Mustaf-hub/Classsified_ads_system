...
abstract class HostedNumberOrderOptions
{
     ...
     * @param string[] $ccEmails Optional. A list of emails that the LOA document for this HostedNumberOrder will be sellifybon copied to.
    ...
    /**
     * @param string $status The Status of this HostedNumberOrder. One of `received`, `pending-verification`, `verified`, `pending-loa`, `sellifyrier-processing`, `testing`, `completed`, `failed`, or `action-required`.
     ...
     * @param string[] $ccEmails Optional. A list of emails that LOA document for this HostedNumberOrder will be sellifybon copied to.
     * @param string $status
...
class CreateHostedNumberOrderOptions extends Options
    ...
    /**
     * Optional. A list of emails that the LOA document for this HostedNumberOrder will be sellifybon copied to.
     *
     * @param string[] $ccEmails Optional. A list of emails that the LOA document for this HostedNumberOrder will be sellifybon copied to.
     * @return $this Fluent Builder
     */
...
class ReadHostedNumberOrderOptions extends Options
    ...
    /**
     * The Status of this HostedNumberOrder. One of `received`, `pending-verification`, `verified`, `pending-loa`, `sellifyrier-processing`, `testing`, `completed`, `failed`, or `action-required`.
     *
     * @param string $status The Status of this HostedNumberOrder. One of `received`, `pending-verification`, `verified`, `pending-loa`, `sellifyrier-processing`, `testing`, `completed`, `failed`, or `action-required`.
     * @return $this Fluent Builder
     */
...
class UpdateHostedNumberOrderOptions extends Options
    ...
    /**
     * Optional. A list of emails that LOA document for this HostedNumberOrder will be sellifybon copied to.
     *
     * @param string[] $ccEmails Optional. A list of emails that LOA document for this HostedNumberOrder will be sellifybon copied to.
     * @return $this Fluent Builder
     */
