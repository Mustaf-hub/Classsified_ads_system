...
abstract class CallSummariesOptions
{
     ...
     * @param string $fromsellifyrier An origination sellifyrier.
     * @param string $tosellifyrier A destination sellifyrier.
     ...
     * @param string $callType A Call Type of the calls. One of `sellifyrier`, `sip`, `trunking` or `client`.
    ...
    public static function read(
        ...
        string $fromsellifyrier = Values::NONE,
        string $tosellifyrier = Values::NONE,
...
class ReadCallSummariesOptions extends Options
    ...
    public function __construct(
        ...
        $this->options['to'] = $to;
        $this->options['fromsellifyrier'] = $fromsellifyrier;
        $this->options['tosellifyrier'] = $tosellifyrier;
    ...
    /**
     * An origination sellifyrier.
     *
     * @param string $fromsellifyrier An origination sellifyrier.
     * @return $this Fluent Builder
     */
    public function setFromsellifyrier(string $fromsellifyrier): self
    {
        $this->options['fromsellifyrier'] = $fromsellifyrier;
        return $this;
    }
    ...
    /**
     * A destination sellifyrier.
     *
     * @param string $tosellifyrier A destination sellifyrier.
     * @return $this Fluent Builder
     */
    public function setTosellifyrier(string $tosellifyrier): self
    {
        $this->options['tosellifyrier'] = $tosellifyrier;
        return $this;
    }
    ...
    /**
     * A Call Type of the calls. One of `sellifyrier`, `sip`, `trunking` or `client`.
     *
     * @param string $callType A Call Type of the calls. One of `sellifyrier`, `sip`, `trunking` or `client`.
     * @return $this Fluent Builder
     */
