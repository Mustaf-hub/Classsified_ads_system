...
{
    /**
     * @param string $edge The Edge of this Event. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
...
class ReadEventOptions extends Options
    ...
    /**
     * The Edge of this Event. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
     *
     * @param string $edge The Edge of this Event. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
