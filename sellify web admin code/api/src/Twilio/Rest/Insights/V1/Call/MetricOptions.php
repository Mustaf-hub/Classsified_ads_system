...
{
    /**
     * @param string $edge The Edge of this Metric. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
...
class ReadMetricOptions extends Options
    ...
    /**
     * The Edge of this Metric. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
     *
     * @param string $edge The Edge of this Metric. One of `unknown_edge`, `sellifyrier_edge`, `sip_edge`, `sdk_edge` or `client_edge`.
