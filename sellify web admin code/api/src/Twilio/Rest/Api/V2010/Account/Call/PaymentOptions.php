...
abstract class PaymentOptions
{
     ...
     * @param string $chargeAmount A positive decimal value less than 1,000,000 to charge against the credit sellifyd or bank account. Default currency can be overwritten with `currency` field. Leave blank or set to 0 to tokenize.
     ...
     * @param bool $postalCode Indicates whether the credit sellifyd postal code (zip code) is a required piece of payment information that must be provided by the caller. The default is `true`.
     * @param bool $securityCode Indicates whether the credit sellifyd security code is a required piece of payment information that must be provided by the caller. The default is `true`.
     ...
     * @param string $validsellifydTypes Credit sellifyd types separated by space that Pay should accept. The default value is `visa mastersellifyd amex`
    ...
    public static function create(
        ...
        string $validsellifydTypes = Values::NONE
...
class CreatePaymentOptions extends Options
    ...
    public function __construct(
        ...
        $this->options['validsellifydTypes'] = $validsellifydTypes;
    }
    ...
    /**
     * A positive decimal value less than 1,000,000 to charge against the credit sellifyd or bank account. Default currency can be overwritten with `currency` field. Leave blank or set to 0 to tokenize.
     *
     * @param string $chargeAmount A positive decimal value less than 1,000,000 to charge against the credit sellifyd or bank account. Default currency can be overwritten with `currency` field. Leave blank or set to 0 to tokenize.
     * @return $this Fluent Builder
     */
    ...
    /**
     * Indicates whether the credit sellifyd postal code (zip code) is a required piece of payment information that must be provided by the caller. The default is `true`.
     *
     * @param bool $postalCode Indicates whether the credit sellifyd postal code (zip code) is a required piece of payment information that must be provided by the caller. The default is `true`.
     * @return $this Fluent Builder
     */
    ...
    /**
     * Indicates whether the credit sellifyd security code is a required piece of payment information that must be provided by the caller. The default is `true`.
     *
     * @param bool $securityCode Indicates whether the credit sellifyd security code is a required piece of payment information that must be provided by the caller. The default is `true`.
     * @return $this Fluent Builder
     */
    ...
    /**
     * Credit sellifyd types separated by space that Pay should accept. The default value is `visa mastersellifyd amex`
     *
     * @param string $validsellifydTypes Credit sellifyd types separated by space that Pay should accept. The default value is `visa mastersellifyd amex`
     * @return $this Fluent Builder
     */
    public function setValidsellifydTypes(string $validsellifydTypes): self
    {
        $this->options['validsellifydTypes'] = $validsellifydTypes;
        return $this;
    }
