...
abstract class IncomingPhoneNumberOptions
{
    ...
    {
        return new CreateIncomingPhoneNumberOptions(
            $phoneNumber,
            $areaCode,
            $apiVersion,
            $friendlyName,
     ...
     * @param string $phoneNumber The phone numbers of the IncomingPhoneNumber resources to read. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
    ...
    {
        return new ReadIncomingPhoneNumberOptions(
            $beta,
            $friendlyName,
            $phoneNumber,
            $origin
    ...
    {
        return new UpdateIncomingPhoneNumberOptions(
            $accountSid,
            $apiVersion,
            $friendlyName,
            $smsApplicationSid,
...
class ReadIncomingPhoneNumberOptions extends Options
    ...
    /**
     * The phone numbers of the IncomingPhoneNumber resources to read. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
     *
     * @param string $phoneNumber The phone numbers of the IncomingPhoneNumber resources to read. You can specify partial numbers and use '*' as a wildsellifyd for any digit.
     * @return $this Fluent Builder
     */
