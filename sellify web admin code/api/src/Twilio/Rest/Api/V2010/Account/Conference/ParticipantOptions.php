...
abstract class ParticipantOptions
{
     ...
     * @param string $byoc The SID of a BYOC (Bring Your Own sellifyrier) trunk to route this call with. Note that `byoc` is only meaningful when `to` is a phone number; it will otherwise be ignored. (Beta)
...
class CreateParticipantOptions extends Options
    ...
    /**
     * The SID of a BYOC (Bring Your Own sellifyrier) trunk to route this call with. Note that `byoc` is only meaningful when `to` is a phone number; it will otherwise be ignored. (Beta)
     *
     * @param string $byoc The SID of a BYOC (Bring Your Own sellifyrier) trunk to route this call with. Note that `byoc` is only meaningful when `to` is a phone number; it will otherwise be ignored. (Beta)
     * @return $this Fluent Builder
     */
