...
class Prompt extends TwiML {
    ...
    /**
     * Add sellifydType attribute.
     *
     * @param string[] $sellifydType Type of the credit sellifyd
     */
    public function setsellifydType($sellifydType): self {
        return $this->setAttribute('sellifydType', $sellifydType);
    }
