          ...
          <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $sellify->query("select * from tbl_category");
										$i=0;
...
<td>
										   ...
										   <a href="add_category.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
