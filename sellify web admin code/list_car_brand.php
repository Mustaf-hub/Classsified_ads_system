        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Car Brand List Management</h3>
                </div>
                        ...
                        <thead>
                          <tr>
							...
							<th>Car Brand Title</th>
											<th>Car Brand Image</th>
												<th>Car Brand Status</th>
												<th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $sellify->query("select * from car_brand");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_car_brand.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
