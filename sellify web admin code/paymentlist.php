                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $sellify->query("SELECT * FROM `tbl_payment_list` where id!=5");
$i = 0;
while($row = $stmt->fetch_assoc())
{
	$i = $i + 1;
										   ...
										   <a href="edit_payment.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
