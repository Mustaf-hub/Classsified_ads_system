...
$kb = $sellify->query("SELECT * FROM `tbl_payment_list` where id=11")->fetch_assoc();
...
$data = array(
    ...
    'items' => array(
        array(
            ...
            'category_id' => 'sellify_electronics',
            'quantity' => 1,
            'currency_id' => 'BRL',
	...
	'back_urls'=>array(
	'success'=>$main_url.'/merpago/success.php',
	'failure'=>$main_url.'/merpago/success.php',
	'pending'=>$main_url.'/merpago/pending.php'
	),
	'redirect_urls'=>array(
	'success'=>$main_url.'/merpago/success.php',
	'failure'=>$main_url.'/merpago/success.php',
