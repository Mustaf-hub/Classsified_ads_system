<?php
require dirname(dirname(dirname( dirname(__FILE__) ))).'/inc/Config.php';
$kb = $sellify->query("SELECT * FROM `tbl_payment_list` where id=8")->fetch_assoc();
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_CALLBACK_URL 	= $main_url."/paytm/response.php";
