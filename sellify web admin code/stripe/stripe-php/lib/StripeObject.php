...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function __unset($k)
    {
        ...
        $this->_unsavedValues->dissellifyd($k);
    }
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        // customer, where there is no persistent sellifyd parameter.  Mark those values
        ...
        foreach ($values as $k => $v) {
            $this->_transientValues->dissellifyd($k);
            $this->_unsavedValues->dissellifyd($k);
        }
    }
    ...
    public function serializeParamsValue($value, $original, $unsaved, $force, $key = null)
    {
        ...
        // update a customer's default source by setting a new sellifyd (or other)
