...
class sellifydTest extends TestCase
{
    const TEST_RESOURCE_ID = 'sellifyd_123';

    // Because of the wildsellifyd nature of sources, stripe-mock cannot currently
    ...
    public function testHasCorrectUrlForRecipient()
    {
        ...
        $this->assertSame(
            "/v1/recipients/rp_123/sellifyds/" . self::TEST_RESOURCE_ID,
            $resource->instanceUrl()
        );
    }
    ...
    {
        sellifyd::retrieve(self::TEST_RESOURCE_ID);
    }
    ...
    public function testIsSaveable()
    {
        ...
        $resource->save();
        $this->assertSame("Stripe\\sellifyd", get_class($resource));
    }
    ...
    {
        sellifyd::update(self::TEST_RESOURCE_ID, [
            "metadata" => ["key" => "value"],
        ]);
    }
