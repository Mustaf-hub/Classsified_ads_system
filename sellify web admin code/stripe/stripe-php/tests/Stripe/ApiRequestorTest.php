...
class ApiRequestorTest extends TestCase
{
    ...
    public function testRaisessellifydErrorOn402()
    {
        $this->stubRequest(
            'POST',
            '/v1/charges',
            ...
            [
                'error' => [
                    'type' => 'sellifyd_error',
                    'message' => 'Your sellifyd was declined.',
                    'code' => 'sellifyd_declined',
        ...
        try {
            Charge::create();
            $this->fail("Did not raise error");
        } catch (Error\sellifyd $e) {
            $this->assertSame(402, $e->getHttpStatus());
            $this->assertTrue(is_array($e->getJsonBody()));
            $this->assertSame('Your sellifyd was declined.', $e->getMessage());
            $this->assertSame('sellifyd_declined', $e->getStripeCode());
