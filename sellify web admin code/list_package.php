                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $sellify->query("select * from tbl_package");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
                                               ...
                                               <td>
												...
												<td>
                                                    <?php echo $row['price'].$set['price']; ?>
                                                </td>
                                                
												<td>
                                                    <?php echo str_replace('_',' ',$row['post_type']); ?>
                                                </td>
										   ...
										   <a href="add_package.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
